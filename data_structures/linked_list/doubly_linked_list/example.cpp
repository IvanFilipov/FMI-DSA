 ...
 * @author Ivan Filipov
 * @date   10.2018
 * @brief  Example usage of custom doubly linked list.
 *         Tests with some STL algorithms.
 */
 
#include <iostream>  // std::cout
#include <algorithm> // std::count_if(), std::transform(), 
                     // std::is_sorted(), std::reverse(), std::merge()
#include "dlinked_list.hpp" // dsa::dlinked_list

using dsa::dlinked_list;

/// test the basic interface of our list
